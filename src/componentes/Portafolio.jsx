    ...
    return (
        <div className="container">
            ...
            <div className="divHabi">
                <Card
                    style={{ width: "18rem", background: "#04076d" }}
                    className="card"
                >
                    <Card.Img
                        variant="top"
                        ...
                        >
                            <div className="contCard">
                                <Card.Text style={{ color: "#f2d43e" }}>
                                    ...
                                    API. En entorno Web. Funcionalidad de
                                    carrito de compras, filtrado de productos
                                    por categoría e inicio de sesión, carrusel
                                    de imágenes y responsivo
                                </Card.Text>
                            </div>
                        </a>
                    ...
                    <Card.Body>
                        ...
                        >
                            <div className="contCard">
                                <Card.Text style={{ color: "#f2d43e" }}>
                                    Desarrollado a través del consumo de una
                                    API. En entorno Web. Donde se realiza un
                                    CRUD (Create, Read, Update, Delete), de
                                    Usuario
                                </Card.Text>
                            </div>
                        </a>
